...
class Dairy {
    constructor() {
        this.Tasks = [
            new Task(0, "12.9.2016", "8:00", "task 1"),
            new Task(1, "12.9.2016", "8:30", "task 2"),
            new Task(2, "12.9.2016", "9:00", "task 3"),
            new Task(3, "12.9.2016", "10:00", "task 4"),
            new Task(4, "13.9.2016", "8:30", "task 5"),
            new Task(5, "13.9.2016", "9:00", "task 6")
        ];
    }
